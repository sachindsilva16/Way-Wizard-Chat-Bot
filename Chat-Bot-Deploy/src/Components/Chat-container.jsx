                    ...
                    <div className="flex flex-row justify-between md:space-x-4 p-2  items-center md:ml-10 md:w-32 ">
                        <div className="flex-1 text-center">
                            <span className="text-gray-400 hover:text-gray-800">
                                <span className="inline-block align-text-bottom relative right-20">
                        ...
                        <div className="flex-1">
                            ...
                            <SendButtonIcon type="submit" className="bg-blue-400 w-10 h-10 rounded-full inline-block bg-gradient-to-r from-violet-600 to-indigo-500 flex justify-center items-center hover:-translate-y-0.5 duration-300 hover:bg-opacity-90 relative right-20" />
